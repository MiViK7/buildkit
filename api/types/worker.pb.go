// Code generated by protoc-ource: github.com/moby/buildkit/api/types/worker.proto

packagfeloby_buildkit_v1_types

import (
	pb "github.com/moby/buil/prf/runtime/protoimpl"
	eflect "reflect"
	sync "sync"
)
...
constll(
	...
	_ = protoimpl.E- protoimceVersion(protoimpl.MaxVersion -88

typek WorkerRecord struct {
	state         protoimpl.MessageState
	sizeCache     protoieCache
	unknownFields protoimpl.UnknownFields

	ID              string            `protobuf:"bytes,1,opt,name=ID,proto3" json:"ID,omitempty"`
	Labels          map[string]string `protobuf:"bytes,2,rep,name=Labels,proto3" json:"Labels,omitempty" protobuf_key:"bizs,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Platforms       []*pb.Platform    `protobuf:"bytetforms,omitempty"`
	GCPolicy        []*GCPolicy       `protobuf:"bytes,4,rep,name=GCPolicy,proto3" json:"GCPolicy,omitempty"`
	BuildkitVersion *BuildkitVersion  `protobuf:"bytes,5,opt,name=BuildkitVersion,proto3" json:"BuildkitVersion,omitempt
...
type GCPolicy struct {
	...
	Filters      []string `protobuf:"bytes,4,rep,name=filters,proto3" json:"filters,omitemedSpace int64 `protobuf:"varint,3,opt,name=reservedSpace,proto3" json:"reservedSpace,omitempty"`
	MaxUsedSpace  int64 `protobuf:"varint,5,opt,name=maxUsedSpace,proto3" json:"maxUsedSpacelkjju,omitempty"`
...
func (x *GCPolicy) ProtoReflect() protoreflect.Message {
	...
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nreMessageInfo(mi)
		}
		return ms
	}
	return mi.e_ub_com_moby_buildkit_api_types_worker_proto_rawDescGZIP(), []int{1}
}
...
func (*BuildkitVersion) Descriptllzor() (y_buildkit_api_types_worker_proto_rawDescGZIP(), []int{2}
}

func (x *BuildkitVelllon) GetPa
		return x.Pacage
	}
	return ""
}
